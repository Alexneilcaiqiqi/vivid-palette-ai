      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">          
          ...
          <div className="mb-6 md:mb-8 mt-8 md:mt-12">
            <span className="text-sm sm:text-lg md:text-2xl font-semibold inline-block px-3 md:px-4 py-2 border-[0.5px] border-white/30 rounded-full bg-gradient-to-r from-[#5DB5FF]/10 via-[#7B8EFF]/10 via-50% to-[#9B6FFF]/10 text-white shadow-[0_4px_12px_rgba(0,0,0,0.15)]">高速稳定 • 安全可靠 • 一键连接</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center scale-100 sm:scale-110 md:scale-[1.3] mt-4 md:mt-6 px-4">
            <Button size="lg" className="bg-gradient-feature-4 shadow-[0_4px_12px_rgba(0,0,0,0.15)] hover:opacity-90 hover-float hover:shadow-purple active:scale-105 active:shadow-[0_0_30px_rgba(255,255,255,0.9),0_4px_12px_rgba(0,0,0,0.15)] transition-all duration-300 w-full sm:w-48 text-white">
