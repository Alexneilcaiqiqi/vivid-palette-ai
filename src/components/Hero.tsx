...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-20 floating-particles" style={{background: 'linear-gradient(to top, #FF4500, #FF6500, #FF8500)'}}>
