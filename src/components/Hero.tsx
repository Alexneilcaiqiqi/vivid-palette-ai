    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">          
          ...
          <h1 className="text-5xl md:text-7xl font-song font-light mb-6 leading-tight tracking-[0.2em] mt-[112px] bg-[linear-gradient(180deg,hsl(45_65%_70%),hsl(35_55%_55%))] bg-clip-text text-transparent">
            倦鸟归巢 一键回国
          </h1>
