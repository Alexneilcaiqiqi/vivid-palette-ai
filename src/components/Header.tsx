  ...
  return <header className="fixed top-0 left-0 right-0 z-50" role="banner">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Button variant="default" size="sm" className="bg-gradient-to-b from-[#5DB5FF] via-[#7B8EFF] via-85% to-[#9B6FFF] text-white shadow-cyan hover:shadow-purple hover:scale-105 transition-all duration-300" asChild>
      ...
      {isMenuOpen && <div className="md:hidden glass-effect border-t border-border/50">
          <nav className="container mx-auto px-4 py-4 space-y-4">
            ...
            <div className="flex flex-col space-y-2 pt-4 border-t border-border/50">
              ...
              <Button variant="default" size="sm" className="bg-gradient-to-b from-[#5DB5FF] via-[#7B8EFF] via-85% to-[#9B6FFF] text-white" asChild>
                <Link to="/auth">免费试用</Link>
              </Button>
            </div>
          </nav>
