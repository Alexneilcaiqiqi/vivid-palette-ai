      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">          
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center scale-100 sm:scale-110 md:scale-[1.3] -mt-6 md:-mt-12 px-4">
            <Button size="lg" className="bg-gradient-to-r from-[#5DB5FF] via-[#7B8EFF] via-50% to-[#9B6FFF] shadow-[0_4px_12px_rgba(0,0,0,0.15)] active:scale-105 active:shadow-[0_0_30px_rgba(255,255,255,0.9),0_4px_12px_rgba(0,0,0,0.15)] transition-all duration-300 pulse-strong w-full sm:w-48 text-white">
