  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center pt-24 pb-20 floating-particles" aria-label="首页英雄区">
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">          
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-light mb-6 leading-tight text-white tracking-[0.1em] md:tracking-[0.2em] mt-16 md:mt-[112px] neon-text" itemProp="headline">
            倦鸟归巢 一键回国
          </h1>
