            ...
            return (
              ...
              >
                ...
                <div className="relative w-14 h-14 md:w-16 md:h-16 mb-4 md:mb-6">
                  {/* 外层光晕 */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${scenario.gradient} rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-all duration-500`}></div>
                  {/* 图标主体 */}
                  <div className={`relative w-full h-full bg-gradient-to-br ${scenario.gradient} rounded-2xl p-3 shadow-[0_8px_32px_rgba(0,0,0,0.12)] backdrop-blur-sm group-hover:scale-110 group-hover:shadow-[0_12px_48px_rgba(0,0,0,0.18)] transition-all duration-500`}>
                    {/* 内部高光 */}
