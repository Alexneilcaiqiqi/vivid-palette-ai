...
const Footer = () => {
  return (
    <footer className="relative py-20 border-t border-border/50" id="contact">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/auth" className="text-muted-foreground hover:text-primary transition-colors">免费试用</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/download" className="text-muted-foreground hover:text-primary transition-colors flex items-center">
