      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-20">          
          ...
          <div className="mb-6 md:mb-8 mt-8 md:mt-12">
            <span className="text-sm sm:text-lg md:text-2xl font-semibold inline-block px-3 md:px-4 py-2 border border-primary/30 rounded-full bg-gradient-to-r from-[#5DB5FF] via-[#7B8EFF] via-50% to-[#9B6FFF] text-white shadow-[0_4px_12px_rgba(0,0,0,0.15)]">高速稳定 • 安全可靠 • 一键连接</span>
          </div>
