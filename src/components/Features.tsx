      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-10 px-4">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className="group relative p-4 sm:p-5 md:p-6 bg-card/40 rounded-2xl border border-white/30 hover:-translate-y-2 hover:border-white/60 transition-all duration-500"
