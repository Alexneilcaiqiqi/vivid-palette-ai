    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass-effect">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between bg-black">
        ...
        <nav className="hidden md:flex items-center space-x-4 tracking-wide ml-auto mr-8">
          <a href="#home" className="px-4 py-2 bg-muted/20 rounded-xl text-muted-foreground hover:text-white hover:font-bold hover:bg-muted/40 transition-all duration-300 relative group font-light">
            首页
          </a>
          <a href="#features" className="px-4 py-2 bg-muted/20 rounded-xl text-muted-foreground hover:text-white hover:font-bold hover:bg-muted/40 transition-all duration-300 relative group font-light">
            产品特色
          </a>
          <a href="#pricing" className="px-4 py-2 bg-muted/20 rounded-xl text-muted-foreground hover:text-white hover:font-bold hover:bg-muted/40 transition-all duration-300 relative group font-light">
            套餐价格
          </a>
          <a href="/download" className="px-4 py-2 bg-muted/20 rounded-xl text-muted-foreground hover:text-white hover:font-bold hover:bg-muted/40 transition-all duration-300 relative group font-light">
            下载客户端
          </a>
          <a href="#contact" className="px-4 py-2 bg-muted/20 rounded-xl text-muted-foreground hover:text-white hover:font-bold hover:bg-muted/40 transition-all duration-300 relative group font-light">
            联系我们
          </a>
        </nav>
